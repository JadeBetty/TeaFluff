...
module.exports = {
    name: `hack`,
    description: "Hack someone on Discord (Just for fun)",
    category: "Fun",
    deleteTrigger: true,
    run: async (client, message, args) => {
        ...
        ) return message.channel.send("```diff\n- SyntaxError: Cannot hack this user.```");
        ...
        const msg = await message.channel.send(text[randomText]);
        await setTimeout(() => {
