...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        const listWarnings = () => {
            ...
            const warnings = warningsSchema.find(
                ...
                async (err, data) => {
                    ...
                    if (data) {
                        let theData = data.map((d, i) => `**${i + 1}. Warning**\n**Warn ID:** ${d._id
        ...
        const deleteWarning = () => {
            ...
            warningsSchema.findOneAndDelete(
                ...
                async (err, data) => {
                    ...
                    if (data) {
                        const warnDeleteEmbed = new EmbedBuilder()
                            .setAuthor({
                                name: target.user.tag,
                                iconURL: target.displayAvatarURL({ dynamic: true }),
                            })
                        ...
                        const warnDeleteDmEmbed = new EmbedBuilder()
                            .setAuthor({
                                name: message.guild.name,
        ...
        if (method == 'remove' || "delete") return deleteWarning();
